...
#ifndef NEURALNETWORK_CONNECTOR
#define NEURALNETWORK_CONNECTOR
...
namespace neuralnetwork_connector {
	/*
	Functions used to interact with OpenCV NeuralNetwork Library
	...
	*/
	...
	The NeuralNetwork will be saved in /NNetwork/[UserID].xml
